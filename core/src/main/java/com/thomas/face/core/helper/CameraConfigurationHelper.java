...
public class CameraConfigurationHelper {
    ...
    public void initFromCameraParameters(Camera camera) {
        Point screenResolution = ScreenHelper.getScreenResolution(mContext);
        Point screenResolutionForCamera = new Point();
        screenResolutionForCamera.x = screenResolution.x/2;
        screenResolutionForCamera.y = screenResolution.y/2;

        if (ScreenHelper.isPortrait(mContext)) {
            screenResolutionForCamera.x = screenResolution.y/3;
            screenResolutionForCamera.y = screenResolution.x/3;
        }
